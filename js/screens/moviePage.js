...
class MoviePage extends BaseComponent {
    ...
    async render() {
        ...
        <iframe width="760" height="515" src="${db.docs[0].data().trailer2}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        <span class="closer">
